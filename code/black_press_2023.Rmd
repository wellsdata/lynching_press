...
# Oct 11 data cleaning and compiling
...
#BP page one analysis: Not using in final paper
...
#42% of BP lynching articles on page one 
bp_pageplacement <- bp_index_pages %>% 
count(page_one) %>% 
  mutate(pct =(n/sum(n)))
...
bp_pages_decade %>%
  ...
  labs(title = "Black Press Percentage Page One Lynching Stories, 1910-1960", 
       ...
       caption = "Page 1 lynching stories peaked at 39% in the 1910s and 1940s. Graphic by (redacted - peer review), 6/21/2024",
       y="Pct of Pages",
       x="Decade")
