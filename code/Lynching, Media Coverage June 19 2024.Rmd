...
#Index of 11,396 articles of text extracted from 60,000 lynchin articles

index2 <- read_csv("https://osf.io/download/fwzny/?view_only=6c106acd6cb54f6f849e8c6f9098809f") %>%
  as.data.frame()

# 1650 articles from the black press
# from master_article_index_6_17 has 11,396 articles

blackindex_master <- read_csv("https://osf.io/download/se69z/?view_only=6c106acd6cb54f6f849e8c6f9098809f")
```
...
#Sandwich it onto a simple ggplot
  ...
  labs(title = "Lynching Coverage By Year, 1789-1963", 
       ...
       caption = "n=60,042 pages. Peak page count: 1903: 2,971 pages. Graphic by (redacted - peer review), 6/21/2024",
       y="Count of Pages",
       x="Year")
...
pages_decade %>% 
  ...
  labs(title = "Percentage Page One Lynching Stories, 1830-1960", 
       ...
       caption = "Page 1 lynching stories peaked at 46% in the 1920s. Graphic by (redacted - peer review), 6/21/2024",
       y="Pct of Pages",
       x="Decade")


ggsave(here::here("../lynching_press/output_images_tables/Article_Images/Figure_9_pages_decade_6_21_2024.png"),device = "png",width=9,height=6, dpi=800)
...
newspaper_top %>%
  ...
  save_kable("../output_images_tables/top_newspapers_6_21_2024.png")
...
region %>% 
  ...
  labs(title = "Regional Distribution of Lynching Coverage, 1789-1963", 
       ...
       caption = "Newspapers by region with lynching coverage. n=60,042 pages. Graphic by (redacted - peer review), 6/21/2024",
       y="Pct of Pages",
       x="Region")



ggsave(here::here("../lynching_press/output_images_tables/Article_Images/Figure_2_regional_coverage_6_21_2024.png"),device = "png",width=9,height=6, dpi=800)
```
...
tolnay_beck %>% 
  count(status_clean) 
```
### Lynching Totals, Tolnay & Beck, 2022
### Figure 3
```{r}
tolnay_beck <- tolnay_beck %>% 
  mutate(
...
pl <- pl + labs(title = "Media Coverage vs Lynchings, 1865-1963", 
        ...
        caption = "Tolnay_Beck Victims n = 5871. Media n = 59,597 pages. Graphic by (redacted - peer review), 4/11/2023")
...
ggplot(aes(x=year)) +
  ...
  labs(title = "UMD Lynching News vs Pfiefer Lynching Data",
       ...
       Graphic by (redacted - peer review). March 6, 2023",
       x = "Year")
...
egraf1 <- e %>% 
  ...
  labs(title = "Lynching News to Overall News Coverage, 1789-1963", 
       ...
       caption = "Graphic by (redacted - peer review), 9/24/2022",
...
dl <- dl + labs(title = "Weighted Media Coverage vs Pct of total Lynchings, 1865-1963", 
        ...
        caption = "tolnay_beckVictims n = 7064. Media n = 108,575 pages / 18 million pages. Graphic by (redacted - peer review), 9/24/2022")
...
egraf <- e %>% 
  ...
  labs(title = "Ratio of Lynchings to News Stories, 1865-1946", 
       ...
       caption = "1947 & beyond filtered as outlier. Graphic by (redacted - peer review), 9/24/2022",
