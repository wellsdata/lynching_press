...
# CHECK CHECK Figure 12: Newspaper, lynch mobs and justice narrative. 
```{r}
...
# CHECK Figure 13: Regional trends lynching and justice. 
```{r}
...
#Figure 13: Common narratives in Black press coverage of lynching
in Black Papers Topic Modeling, 3_16_2023.rmd

#Figure 14 mainstrean_topics_june27.png
in Mainstream Papers topic Modeling.rmd, Line 224


#Figure 15: Compare White / Black Article Counts
```{r}
...
wp_bp_comparison |> 
 kable() %>%
  ...
  save_kable("../output_images_tables/wp_bp_sample_decade_10_16_2024.png")
