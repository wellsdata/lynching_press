...
```{r}
mob_decade <- read_csv("../output_images_tables/mob_decade_trends.csv")
...
mob_long %>%
  ...
  labs(
    title = "Lynch mobs portrayed neutrally in at least one-third of newspapers",
    subtitle = "Percent of news coverage by decade portraying lynch mobs as hostile, orderly or neutral",
    caption = "1800s removed, lack of data. n=2,704 articles. Graphic by (redacted - peer review), 10/19/2024",
    y = "Pct of Pages",
    x = "Decade",
    fill = "Story Type"
  ) 
...
ggsave(here::here("../lynching_press/output_images_tables/Article_Images/Figure_11_mob_coverage_10_19_2024.png"),device = "png",width=9,height=6, dpi=800)
...
justice %>%
  ...
  geom_col(position = "dodge", stat = "identity") +
  scale_fill_manual(
    values = c("percent_justice" = "blue"),
    labels = c("Hostile", "Neutral", "Orderly")
  ) +
  theme(legend.position = "none") +
  labs(
    title = "News of lynching as 'justice' drops after 1830s",
    subtitle = "Percent of news coverage by decade equating lynch mobs as performing justice",
    caption = "1800s removed, lack of data. n=2,704 articles. Graphic by (redacted - peer review), 10/19/2024",
    y = "Pct of Pages",
    x = "Decade") 


ggsave(here::here("../lynching_press/output_images_tables/Article_Images/Figure_13_mob_justice_10_19_2024.png"),device = "png",width=9,height=6, dpi=800)
