...
new_main_index <- clean_main_index
...
```{r}
master_article_index_4_18 <- read_csv("/Users/robwells/Code/hcij_lynching_phase_two/narratives/data/extracted_database_index_april_16.csv") %>% 
  clean_names()
