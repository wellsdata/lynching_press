...
white_lynch %>% 
  ...
  labs(title = "White newspaper articles",
       subtitle = "Based in  9589 extracted articles, 1805-1963",
       caption = "Graphic by (redacted - peer review), 6-27-2024",
       y="number",
       x="year")
...
black_press_master_june_26_2024 %>% 
  ...
  labs(title = "Black newspaper articles",
       subtitle = "Based in 1650 extracted articles, 1805-1963",
       caption = "Graphic by (redacted - peer review), 6-27-2024",
       y="number",
       x="year")
